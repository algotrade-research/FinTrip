...
if __name__ == "__main__":
    ...
    financial_path = "mock/out-sample/financial_data.csv" if args.mode == "validation" \
                else "mock/in-sample/financial_data.csv"
    daily_path = "mock/out-sample/daily_data.csv" if args.mode == "validation" \
                else "mock/in-sample/daily_data.csv"
    index_path = "mock/out-sample/index_data.csv" if args.mode == "validation" \
