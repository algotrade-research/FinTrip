...
class TestFinancial(unittest.TestCase):
    ...
    def test_eps(self):
        ...
        eps = financial.eps()
        eps_val = eps[(eps["year"] == year) & (eps["quarter"] == quarter) & (eps["tickersymbol"] == firm)]
    ...
    def test_quick_ratio(self):
        ...
        quick_ratio_val = quick_ratio[(quick_ratio["year"] == year) & (quick_ratio["quarter"] == quarter) & (quick_ratio["tickersymbol"] == firm)]
    ...
    def test_gross_margin(self):
        ...
        gross_margin_val = gross_margin[(gross_margin["year"] == year) & (gross_margin["quarter"] == quarter) & (gross_margin["tickersymbol"] == firm)]
    ...
    def test_roe(self):
        ...
        ti_val = ti[(ti["year"] == year) & (ti["quarter"] == quarter) & (ti["tickersymbol"] == firm)]
    ...
    def test_get_signal(self):
        ...
        for signal in signals:
            if signal == "eps":
                pd_testing.assert_frame_equal(financial.eps(), financial.get_signal(signal))

            elif signal == "gm":
                pd_testing.assert_frame_equal(financial.gross_margin(), financial.get_signal(signal))

            elif signal == "quick-ratio":
                pd_testing.assert_frame_equal(financial.quick_ratio(), financial.get_signal(signal))
                
            elif signal == "roe":
                pd_testing.assert_frame_equal(financial.roe(), financial.get_signal(signal))
                
            elif signal == "turnover-inv":
                pd_testing.assert_frame_equal(financial.turnover_inventory(), financial.get_signal(signal))
    ...
    def test_filter_median(self):
        ...
        for signal in signals:
            ...
            filtered = filtered[(filtered["year"] == year) & (filtered["quarter"] == quarter)]
